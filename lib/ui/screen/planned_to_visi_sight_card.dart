...
/*
* This class displays short info about the planned to visit sight
*/
class PlannedToVisitSightCard extends StatelessWidget {
  const PlannedToVisitSightCard({Key? key, required this.sight}) : super(key: key);

  final PlannedToVisitSight sight;
